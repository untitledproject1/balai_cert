<?php $__env->startSection('card-header-dok', 'Dokumen MOU'); ?>
...
<div class="header_title">
    <b class="text-center">
        ...
        Dengan <br>
        <?php echo e(strtoupper($user->nama_perusahaan)); ?> <br>
    </b>
</div>

<hr class="hr_dok">
<p class="text-center">Nomor: <?php echo e($no_surat); ?></p>

<div class="mt-4 ml-4 mr-4">
    <p>Kontrak ini dibuat pada hari <?php echo e($tgl_pembuatan->dayName); ?>, tanggal <?php echo e($tgl_pembuatan->isoFormat('D')); ?>, bulan <?php echo e($tgl_pembuatan->monthName); ?> tahun <?php echo e(date('Y')); ?> oleh dan antara:</p>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo e($user->pimpinan_perusahaan); ?>., dalam hal ini bertindak dalam kedudukannya selaku Direktur <?php echo e($user->nama_perusahaan); ?> yang beralamat perusahaan di <?php echo e($user->alamat_perusahaan); ?>, <?php echo e($user->kota); ?> dan alamat pabrik di <?php echo e($user->alamat_pabrik); ?>,Telp : <?php echo e($user->no_telp); ?>, Fax : <?php echo e($user->no_fax); ?>; untuk selanjutnya disebut Pihak Kedua</td>
        </tr>
    </table>
    ...
    <br>
    <br>
    <p class="text-right">Bandung, <?php echo e($tgl_pembuatan->isoFormat('LL')); ?></p>
    <br>
    ...
    <table width="100%">
        <tr style="text-align: center;">
            <td width="50%">
                Pihak Kedua <br>
                <?php echo e($user->nama_perusahaan); ?> <br><br><br><br><br><br><br>
                <?php echo e($user->pimpinan_perusahaan); ?>
    ...
    <p class="text-center float-right">
        Bandung, <?php echo e($tgl_pembuatan->isoFormat('LL')); ?> <br>
...
<?php echo $__env->make('layouts.dok_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/balai-cert/resources/views/dok/dok_mou.blade.php ENDPATH**/ ?>