        ...
        <div class="row no-gutters">
            <div class="col-lg-5 col-md">
                <div class="regis_left">
                    <img src="<?php echo e(asset('images/bg-regis-min.jpg')); ?>" alt="">
                </div>
            </div>
            ...
            <div class="col-lg-7 col-md-12">
                <div class="container mt-2">
                    ...
                    <div class="regis_right">
                        ...
                        <?php endif; ?>
                        <form id="register" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <p class="text-center mt-5"><span style="font-weight: 500;">sudah punya akun ?</span> <b><a href="<?php echo e(route('login')); ?>">Login</a></b></p>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/balai-cert/resources/views/auth/register.blade.php ENDPATH**/ ?>