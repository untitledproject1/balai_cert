...
<head>
    ...
    <link type="image/png" rel="icon" href="<?php echo e(asset('images/icon/logo-polos.ico')); ?>">
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/simple-sidebar.css')); ?>">
    <!-- Font Awesome -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('css/all.css')); ?>">
    <!-- Data Table -->
    <link rel="stylesheet" href="<?php echo e(url('https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/fixedheader/3.1.2/css/fixedHeader.dataTables.min.css">
    <!-- ====== BS-Stepper ====== -->
    <link rel="stylesheet" href="<?php echo e(asset('css/progress-wizard.min.css')); ?>">
    <!-- Datepicker -->
   <link rel="stylesheet" href="<?php echo e(asset('css/datepicker.min.css')); ?>">
   <script src="<?php echo e(asset ('js/datepicker.min.js')); ?>"></script>
   <script src="<?php echo e(asset ('js/i18n/datepicker.en.js')); ?>"></script>
    <!-- International Tel Input -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('intl-tel-input-16/build/css/intlTelInput.css')); ?>">
    ...
    <title><?php echo e(config('app.name', 'Balai Besar Keramik')); ?></title>
...
<body style="background: #F9F9FB;">
    ...
    <div class="d-none d-md-block d-lg-block d-xl-block">
        ...
        <div class="preloader">
            <div class="loading">
                <img src="<?php echo e(asset('images/preloader.gif')); ?>" width="80">
                <p>Harap Tunggu</p>
            </div>
        </div> 

        <div id="app">
            <div class="<?php echo e(isset($userAuth) && $role != 'client' ? : ''); ?>">

                <?php echo $__env->yieldContent('content-navbar'); ?>
    ...
    <div class="d-sm-block d-md-none mobail">
        <div class="text-center pl-5 pr-5 pt-4">
            <div class="align-self-center">
                <img class="img-fluid pt-4" style="width: 200px;" src="<?php echo e(asset('images/Logo.svg')); ?>" alt="">
                <img class="img-fluid pt-5" src="<?php echo e(asset('images/person-handshake.png')); ?>" alt="">
                <br>
                <br>
                <a href="#"><img class="img-fluid pt-5" style="width: 200px;" src="<?php echo e(asset('images/googleplay.png')); ?>" alt=""></a>
            </div>
        </div>
    </div>
    ...
    <!-- Data Table -->
    <script src="<?php echo e(url('https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(url('https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js')); ?>"></script>

    <!-- Nomor Telepon -->
    <script src="<?php echo e(asset('intl-tel-input-16/build/js/intlTelInput.js')); ?>"></script>
    ...
    <script type="text/javascript">
        function ajaxUpload(ajaxUrl, fileInput, kuisFileName = false, tinjauanPP = false, manufaktur = false) {
            ...
            $('.prUpload').html('<div class="preloader-upload"><div class="loading"><center><img style="width: 80px" src="<?php echo e(asset('images/upload_file.svg')); ?>"><h3 style="color: #000;">Sedang memproses file.....</h3></center></div></div>');
            $('.prUpload').show();
            elem.find('.resUpload').text('');

            formData.append('_token', '<?php echo e(csrf_token()); ?>');
            formData.append('produk_id', <?php echo e(!isset($idProduk) || is_null($idProduk) ? 'null' : $idProduk); ?>);
            formData.append('user', <?php echo e(isset($role) && $role == 'sertifikasi' ? (isset($user) ? $user->id : null) : (isset($userAuth) ? $userAuth->id : null)); ?>);
            ...
            if (tinjauanPP) {
                formData.append('tinjauanPP_id', <?php echo e(!isset($laporanAudit) || is_null($laporanAudit) ? 'null' : $laporanAudit->tinjauan_pp_id); ?>);
            }
            $.ajax({
...
<?php /**PATH /var/www/html/balai-cert/resources/views/layouts/app.blade.php ENDPATH**/ ?>