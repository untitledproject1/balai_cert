...
<div class="mt-4 ml-4 mr-4">
    ...
    <ol>
        <li>Biaya sertifikasi produk untuk tanda SNI (SPPT SNI) dalam rangka sertifikasi awal {{ $user->nama_perusahaan }} adalah sebesar Rp. {{ number_format($biaya_sert, 0, ',', '.') }},(dua puluh tiga juta rupiah) untuk l(satu) lokasi dan 1 (satu) sertifikat SPPT SNI.</li>
