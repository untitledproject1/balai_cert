...
<div class="mt-2 ml-4">
    ...
    <div class="row mt-3 mb-4">
        ...
        <div class="col-lg-10">
            <textarea class="form-control" readonly="">{{ !is_null($infoDB) && !is_null($infoDB->kuis2_opsi) ? $infoDB->kuis2_isi : '' }}</textarea>
        </div>
    </div>
</div>
...
<div class="mt-2 ml-4">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><textarea class="form-control" readonly="" style="height: 100px;">{{ !is_null($infoDB) && $infoDB->kuis3_opsi == 1 ? strtoupper($infoIsi($infoDB->kuis3_isi)[0]) : '' }} - {{ !is_null($infoDB) && $infoDB->kuis3_opsi == 1 ? $infoIsi($infoDB->kuis3_isi)[1] : '' }}
                </textarea></td>
        </tr>
        @endif
    </table>
...
<div class="mt-2 ml-4">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><input class="form-control" type="text" readonly="" value="{{ !is_null($infoDB) && $infoDB->kuis4_opsi == 0 ? $infoIsi($infoDB->kuis4_isi)[1] : '' }}"></td>
        </tr>
        @endif
    </table>
</div>
...
<div class="mt-2 ml-4">
    <div class="row">
        <div class="col-lg">
            <b>Jawaban:</b>
            <input class="form-control" type="text" name="evalDate" value="{{ !is_null($kuesioner) && !is_null($kuesioner->kuis1) ? $kuesioner->kuis1 : '' }}" disabled="">
        </div>
    </div>
</div>
...
<div class="mt-3 ml-4">
    <div class="row">
        <div class="col-lg">
            ...
            <span class="{{ !is_null($kuesioner) && !is_null($kuesioner->kuis2) && $kuesioner->kuis2 === 1 ? 'jawaban_ya' : 'jawaban_ya' }}">{{ !is_null($kuesioner) && !is_null($kuesioner->kuis2) && $kuesioner->kuis2 === 1 ? 'Contoh Produksi' : 'Contoh Prototype' }}</span>
            @else
            <span class="badge badge-secondary">Kosong</span>
            @endif
        </div>
...
<div class="mt-3 ml-4">
    ...
    <span class="{{ !is_null($isi($kuesioner, 'kuis3' , 0)) && $isi($kuesioner, 'kuis3' , 0)===1 ? 'jawaban_ya' : 'jawaban_ya' }}">{{ !is_null($isi($kuesioner, 'kuis3' , 0)) && $isi($kuesioner, 'kuis3' , 0)===1 ? 'Proses Produksi' : 'Proses Contoh Prototipe' }}</span>
    @else
    <span class="badge badge-secondary">Kosong</span>
    @endif
</div>

<div class="kuis_3 ml-4 {{ !is_null($isi($kuesioner, 'kuis3', 0)) && $isi($kuesioner, 'kuis3', 0) !== 1 ? '' : 'hid' }}">
    <div class="row">
        <div class="col-lg">
    ...
    <div class="col-lg">
        <input class="inpt form-control" type="text" name="waktuProduksi" value="{{ !is_null($isi($kuesioner, 'kuis3', 1)) ? $isi($kuesioner, 'kuis3', 1) : '' }}" disabled="">
    </div>
</div>
...
<div class="mt-3 ml-4">
    ...
    <span class="{{ !is_null($isi($kuesioner, 'kuis4' , 0)) && $isi($kuesioner, 'kuis4' , 0)===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis4' , 0)) && $isi($kuesioner, 'kuis4' , 0)===1 ? 'Sudah' : 'Belum' }}</span>
    @else
    <span class="badge badge-secondary">Kosong</span>
    @endif
</div>
...
<div class="kuis_4 {{ !is_null($isi($kuesioner, 'kuis4', 0)) && $isi($kuesioner, 'kuis4', 0) === 1 ? '' : 'hid' }}">
    ...
    <a href="{{ asset('storage/dok/dokKuesioner/standarProduk/'.$isi($kuesioner, 'kuis4', 1)) }}" target="_blank">Lampiran</a><br>
    @endif
</div>
<hr>
...
<div class="ml-4">
    ...
    <div class="mt-3 mb-3">
        ...
        <span class="{{ !is_null($isi($kuesioner, 'kuis_111' , 0)) && $isi($kuesioner, 'kuis_111' , 0)===1 ? 'jawaban_ya' : 'jawaban_ya' }}">{{ !is_null($isi($kuesioner, 'kuis_111' , 0)) && $isi($kuesioner, 'kuis_111' , 0)===1 ? 'Pesanan' : 'Persediaan' }}</span>
        @else
        <span class="badge badge-secondary">Kosong</span>
        @endif
    </div>

    <div class="kuis_111 ml-5 {{ !is_null($isi($kuesioner, 'kuis_111', 0)) && $isi($kuesioner, 'kuis_111', 0) === 1 ? '' : 'hid' }}">
        <div class="row">
            Jika <b>Pesanan</b>, Apakah digunakan sebagai identifikasi kelompok produk yang terpisah?
        </div>
        <div class="mt-3">
            <b>Jawaban:</b>
            <span class="{{ !is_null($isi($kuesioner, 'kuis_111' , 1)) && $isi($kuesioner, 'kuis_111' , 1)===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_111' , 1)) && $isi($kuesioner, 'kuis_111' , 1)===1 ? 'Ya' : 'Tidak' }}</span>
        </div>
    </div>
    ...
    <div class="ml-4 mt-3">
        <b>Jawaban:</b>
        @if(!is_null($isi($kuesioner, 'kuis_112' , 0)))
        <span class="{{ !is_null($isi($kuesioner, 'kuis_112' , 0)) && $isi($kuesioner, 'kuis_112' , 0)===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_112' , 0)) && $isi($kuesioner, 'kuis_112' , 0)===1 ? 'Ya' : 'Tidak' }}</span>
        @else
        <span class="badge badge-secondary">Kosong</span>
        @endif
    </div>

    <div class="kuis_112 mt-3 ml-5 {{ !is_null($isi($kuesioner, 'kuis_112', 0)) && $isi($kuesioner, 'kuis_112', 0) === 1 ? '' : 'hid' }}">
        <div class="row">
            <div class="col-lg">
        ...
        <div class="row">
            ...
            <span class="{{ $isi($kuesioner, 'kuis_112' , 1)===1 ? 'jawaban_tidak' : 'jawaban_ya' }}">
                ...
                Kontainer
                @elseif($isi($kuesioner, 'kuis_112' , 1)===3)
                Produk dan Kontainer
                @endif
            </span>
        </div>
    </div>
    <div class="kuis_112_ ml-4 {{ !is_null($isi($kuesioner, 'kuis_112', 0)) && $isi($kuesioner, 'kuis_112', 0) !== 1 ? '' : 'hid' }}">
        <div class="row">
            <div class="col-lg">
...
<div class="ml-4">
    ...
    <div class="ml-4 mt-3">
        ...
        <span class="{{ !is_null($isi($kuesioner, 'kuis_123' , 0)) && $isi($kuesioner, 'kuis_123' , 0)===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_123' , 0)) && $isi($kuesioner, 'kuis_123' , 0)===1 ? 'Ya' : 'Tidak' }}</span>
        @else
        <span class="badge badge-secondary">Kosong</span>
        @endif
    </div>
    ...
    <div class="ml-4 mt-3">
        ...
        <span class="{{ !is_null($kuesioner) && !is_null($kuesioner->kuis_125) && $kuesioner->kuis_125 === 1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($kuesioner) && !is_null($kuesioner->kuis_125) && $kuesioner->kuis_125 === 1 ? 'Ya' : 'Tidak' }}</span>
        @else
        <span class="badge badge-secondary">Kosong</span>
        @endif
    </div>
    ...
    <div class="ml-4 mt-3">
        ...
        <div class="mt-3 ml-4">
            ...
            <span class="{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[0]) && $isi($kuesioner, 'kuis_126' , 0)[0]===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[0]) && $isi($kuesioner, 'kuis_126' , 0)[0]===1 ? 'Ya' : 'Tidak' }}</span>
            @else
            <span class="badge badge-secondary">Kosong</span>
            @endif
        </div>
        ...
        <div class="mt-3 ml-4">
            ...
            <span class="{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[1]) && $isi($kuesioner, 'kuis_126' , 0)[1]===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[1]) && $isi($kuesioner, 'kuis_126' , 0)[1]===1 ? 'Ya' : 'Tidak' }}</span>
            @else
            <span class="badge badge-secondary">Kosong</span>
            @endif
        </div>
        ...
        <div class="mt-3 ml-4">
            ...
            <span class="{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[2]) && $isi($kuesioner, 'kuis_126' , 0)[2]===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_126' , 0)[2]) && $isi($kuesioner, 'kuis_126' , 0)[2]===1 ? 'Ya' : 'Tidak' }}</span>
            @else
            <span class="badge badge-secondary">Kosong</span>
            @endif
        </div>
    ...
    <div class="mt-3 ml-4">
        <b>Jawaban:</b>
        @if(!is_null($isi($kuesioner, 'kuis_127' , 0)))
        <span class="{{ !is_null($isi($kuesioner, 'kuis_127' , 0)) && $isi($kuesioner, 'kuis_127' , 0)===1 ? 'jawaban_ya' : 'jawaban_tidak' }}">{{ !is_null($isi($kuesioner, 'kuis_127' , 0)) && $isi($kuesioner, 'kuis_127' , 0)===1 ? 'Ya' : 'Tidak' }}</span>
        @else
        <span class="badge badge-secondary">Kosong</span>
        @endif
    </div>

    <div class="kuis_127 ml-4 {{ !is_null($isi($kuesioner, 'kuis_127', 0)) && $isi($kuesioner, 'kuis_127', 0) === 1 ? '' : 'hid' }}">
        <div class="row">
            <div class="col-lg">
...
<div class="mt-3 ml-4">
    ...
    <div id="manual" class="{{ !is_null($bahanHasil) && !is_null($bahanHasil->form_21) ? 'hid' : '' }}">
...
<div class="mt-3 ml-4">
    ...
    <div id="manual11" class="{{ !is_null($bahanHasil) && !is_null($bahanHasil->form_42) ? 'hid' : '' }}">
...
<div class="ml-4 mt3-3">
    ...
    <div class="mt-3 ml-4">
        <b>Jawaban:</b>
        @if(!is_null($isi($bahanHasil, 'form_524' , 0)))
    ...
    <div class="kuis_524 ml-4 mt-3 {{ !is_null($isi($bahanHasil, 'form_524', 0)) && $isi($bahanHasil, 'form_524', 0) === 1 ? '' : 'hid' }}">
