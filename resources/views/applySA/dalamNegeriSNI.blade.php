...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->surat_permohonan_sertifikat_sni }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_iui }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_akte_notaris_perusahaan }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_tdp }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_npwp }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_sert_patent_merek }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->copy_sert_iso_9001 }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->laporan_audit_sistem_mutu_terakhir }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->panduan_mutu }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->daftar_induk_dok }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->struktur_organisasi }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->diagram_alir_proses_produksi }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->surat_pertunjukkan_wakil_manajemen }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->ilustrasi_pembubuhan_tanda_sni }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->tabel_daftar_tipe_produk }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->gambar_dan_spesifikasi_produk }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->tata_letak_pabrik }}</i></p>
    </div>
</div>
@endif
<hr>
...
<div class="row pl-3">
    <div class="col-lg">
        <p>Nama File: <i>{{ $dok->peta_rute_pabrik_dari_bandara_terdekat }}</i></p>
    </div>
</div>
@endif
<hr>
